					...
					<div className="w-9/12">
						<div className="flex flex-col gap-7 items-center w-full">
							...
							<div className="w-full flex flex-col items-end mt-5">
								...
								<div className="flex flex-col w-11/12 gap-2 mt-3"></div>
							</div>
							...
							<div className="w-full flex flex-col items-end mt-5">
								...
								<div className="flex flex-col w-11/12 gap-2 mt-3">
									...
									<Input placeholder={"Day/Month/Year"} type="date" />
								...
								<div className="flex flex-col w-11/12 gap-2 mt-3">
									...
									<div className="flex flex-row items-center gap-3">
										<input
											...
											checked={recordVal === "No, I wouldn't"}
										/>
										<span className="text-primary text-base font-semibold">
											No, I wouldn't
										</span>
